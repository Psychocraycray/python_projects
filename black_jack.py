    ...
    def display(self, show_all_dealers_cards=False):
        ...
        for index, card in enumerate(self.cards):
            if index == 0 and self.dealer and \
             not show_all_dealers_cards and not self.is_blackjack():
                print("hidden")
            else:
                print(card)
    ...
    def check_winner(self, player_hand, dealer_hand, game_over=False):
        if not game_over:
            if player_hand.get_value() > 21:
                ...
                return True
            elif player_hand.is_blackjack() and player_hand.is_blackjack:
                print("both players have a black jake it is a tie:|")
                return True
            if player_hand.is_blackjack():
                print("you have black jake. you wins! :)")
                return True
            elif dealer_hand.is_blackjack():
                print("dealer has a black jake. dealer wins! :(")
                return True
        else:
